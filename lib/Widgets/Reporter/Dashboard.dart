      ...
      Widget build(BuildContext context) {
        ...
        final newsListButton = ButtonTheme(          
          ...
          child: new OutlineButton(
            ...
            borderSide: BorderSide(style: BorderStyle.solid, color: Colors.purple[400]),           
            child: Text(
              "News List",              
        ...
        final postNewsButton = ButtonTheme(          
          ...
          child: new OutlineButton(             
            ...
            highlightedBorderColor: Colors.white,
            borderSide: BorderSide(style: BorderStyle.solid, color: Colors.purple[400]),            
            child: Text("Post News", textAlign: TextAlign.center, style: TextStyle(fontSize: 18.0,color: Colors.white),),              
            onPressed: (){
              Navigator.push(
                context,
